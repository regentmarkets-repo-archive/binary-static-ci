...
public class Validate_NewAccountOnQaServer {
	...
	//Test Method to start browser session
		...
		public void UpgradeToRealAccount()
		{
		    ...
		    UpgradeRealAccount_Action.UpgradeAccount_Action(driver,Constant.UpgradeTitle,FirstName,FamilyName,Constant.accountReason,Constant.firstLineAddress,Constant.secondLineAddress,Constant.city,Constant.state,Constant.zipCode,Constant.phone,Constant.securityQ,Constant.securityAns);
		  //Logout newly created user
		    Navigation_Action.Navigate_To_LogoutPage(driver);
		}
		@Test(priority=2)
