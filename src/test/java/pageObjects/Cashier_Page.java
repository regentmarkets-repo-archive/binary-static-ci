...
public class Cashier_Page {
    ...
    public static WebElement page_title(WebDriver driver){
        ...
        element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='content']/div[2]/div/div[1]/h1")));
    ...
    public static WebElement sub_title(WebDriver driver){
        WebDriverWait wait = new WebDriverWait(driver,30);
        element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='content']/div[2]/div/div[4]/div[1]/h3")));
        Assert.assertTrue(element.isDisplayed());
        return element;
    }
    ...
    public static WebElement deposit(WebDriver driver){
        WebDriverWait wait = new WebDriverWait(driver,30);
        element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='content']/div[2]/div/div[4]/div[2]/div/div/div[3]/div[1]/a")));
        Assert.assertTrue(element.isDisplayed());
        return element;
    }
